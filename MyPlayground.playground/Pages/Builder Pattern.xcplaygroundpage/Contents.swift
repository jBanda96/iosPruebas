//: ### Builder Pattern
//: Permite crear objectos complejos al proveerle datos de entrada paso por paso, en lugar de proveerlos via el constructor
//MARK: - Product
...
public class Employee {
    public func createCombo1() throws -> Hamburger {
        ...
        builder.addToppings([.tomatoes, .lettuce, .pickles])
