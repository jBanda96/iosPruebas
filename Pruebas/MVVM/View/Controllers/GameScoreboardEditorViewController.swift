...
class GameScoreboardEditorViewController: NoNavigationBarViewController {
    
    @IBOutlet weak var homePlayer1View: PlayerScoreboardMoveEditorViewModel!
    @IBOutlet weak var homePlayer2View: PlayerScoreboardMoveEditorViewModel!
    @IBOutlet weak var homePlayer3View: PlayerScoreboardMoveEditorViewModel!

    @IBOutlet weak var awayPlayer1View: PlayerScoreboardMoveEditorViewModel!
    @IBOutlet weak var awayPlayer2View: PlayerScoreboardMoveEditorViewModel!
    @IBOutlet weak var awayPlayer3View: PlayerScoreboardMoveEditorViewModel!
    ...
    public var viewModel: GameScoreboardEditorViewModelFromGame? {
        didSet {
            fillUI()
        }
    }
